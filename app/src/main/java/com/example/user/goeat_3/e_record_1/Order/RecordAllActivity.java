...
public class RecordAllActivity extends AppCompatActivity{
...
//    private TextView btn_return;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSateToolbarColor(RecordAllActivity.this, R.color.colorAccent);
...
//        btn_return.setOnClickListener(this);
        ...
        new RecordAllActivity.ccon().execute("orderingcontent", order_id);
    }
